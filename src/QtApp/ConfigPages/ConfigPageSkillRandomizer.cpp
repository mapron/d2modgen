    ...
    : ConfigPageAbstract(parent)
{
    ...
    addEditors(QList<IValueWidget*>()
               << makeEditor("skillTree",
                             tr("Randomize skill tabs within each character"),
               ...
               << makeEditor("skillDamage",
                             tr("Randomize element types for some damage skills"),
               ...
               << makeEditor("ensureDifferent",
                             tr("Ensure that element types are different from original"),
